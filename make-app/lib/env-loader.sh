...
validate_mcp_config() {
    ...
    if is_true "$INSTALL_MCP_SERVERS"; then
        log_debug "MCP servers enabled, checking configuration..."
        ...
        log_debug "MCP configuration validated successfully"
    fi
...
print_env_debug() {
    ...
    log_debug ""
    log_debug "=== MCP Servers ==="
    log_debug "INSTALL_MCP_SERVERS: ${INSTALL_MCP_SERVERS:-'not set'}"
    log_debug "MCP_SERVER_REPOS: ${MCP_SERVER_REPOS:-'not set'}"
    log_debug "MCP_SERVER_BASE_PATH: ${MCP_SERVER_BASE_PATH:-'not set'}"
    log_debug "=================================="
}
